...
export default function Header() {
    ...
    return (
        <header className='flex justify-between'>
            ...
            <div className='flex gap-2.5 border border-gray-300 rounded-full py-2 px-4 shadow-md shadow-gray-200'>
                <div>Anywhere</div>
            ...
            <Link to={user ? '/account' : '/login'} className='flex gap-2 border border-gray-300 rounded-full py-2 px-4 items-center'>
                ...
                <div className='bg-gray-500 border border-gray-500 rounded-full text-white overflow-hidden'>
